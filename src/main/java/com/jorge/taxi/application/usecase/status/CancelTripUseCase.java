...
/**
* Caso de uso para cancelar un viaje.
*
* <p>Responsabilidades:</p>
* <ul>
*     <li>Buscar el viaje por ID.</li>
*     <li>Ejecutar la transición 1: PENDING → CANCELLED.</li>
*     <li>Ejecutar la transición 2: ACCEPTED → CANCELLED.</li>
...
public class CancelTripUseCase {
    ...
    public CancelTripUseCase(SpringDataTripRepository repository) {
    ...
    public Trip execute(Long tripId) {
        ...
        return repository.save(trip); //Lo salvo por posteriores métricas
    }
}
